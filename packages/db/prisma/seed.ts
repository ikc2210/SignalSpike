...
const templates: TemplateInput[] = [
  ...
  // -------------------------------------------------------------------------
  // PRIORITIES TEMPLATES (31-40)
  // -------------------------------------------------------------------------

  {
    slug: 'mon-legislature-priorities',
    name: 'Legislature: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['national_legislature'],
    targetEntityIds: [],
    ...
    topics: [],
    queryPattern:
      'Based on recent bills introduced, hearings held, and public statements, what AI policy areas appear to be the top strategic priorities for {entity} right now? Which areas are gaining momentum and which are stalling?',
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-executive-priorities',
    name: 'Executive Body: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['executive_body'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s recent executive actions, budget requests, and public statements, what appear to be its top AI governance priorities? What direction is its AI policy focus moving?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-xreg-priorities',
    name: 'Cross-Cutting Regulator: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['cross_cutting_regulator'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s recent enforcement actions, rulemakings, and leadership statements, what AI regulatory priorities is it signaling? Which areas show rising momentum?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-sreg-priorities',
    name: 'Sectoral Regulator: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['sectoral_regulator'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "What AI-related regulatory priorities is {entity} pursuing in its sector, based on recent guidance documents, enforcement actions, and public statements? What is gaining or losing momentum?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-court-priorities',
    name: 'Court / Tribunal: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['court_tribunal'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s recent AI-related rulings and pending cases, what legal questions around AI appear to be its emerging priorities — such as authorship, liability standards, or regulatory deference?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-intl-priorities',
    name: 'International Organization: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['international_organization'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s recent publications, working group outputs, and intergovernmental statements, what AI governance priorities appear to be rising on its agenda?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-frontier-priorities',
    name: 'Frontier Developer: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['frontier_developer'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s recent product launches, safety commitments, policy filings, and executive communications, what appear to be its top strategic AI priorities right now? Which areas are accelerating?",
    cadence: 'weekly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-compute-priorities',
    name: 'Compute Infrastructure Provider: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['compute_infra_provider'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s recent government contracts, export compliance decisions, and infrastructure investments, what AI policy and business priorities appear to be driving its strategy?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-standards-priorities',
    name: 'Standards Body: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['standards_body'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s active work programs, recently published outputs, and public consultations, what AI standards priorities is it signaling? Which technical areas are gaining focus?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
  {
    slug: 'mon-safety-priorities',
    name: 'Safety Institute: Priorities',
    templateType: 'entity_monitoring',
    entityTypes: ['safety_institute'],
    targetEntityIds: [],
    objective: 'priorities',
    topics: [],
    queryPattern:
      "Based on {entity}'s recent evaluation work, published reports, and public statements, what AI safety priorities appear to be rising on its research and policy agenda?",
    cadence: 'monthly',
    domainAllowlist: [],
    active: true,
  },
